...
<ul>
  <li><a href="Homestaffs.php">HOME</a></li>
  <li><a href="logout.php">Logout</a></li>
</ul>
<div>

<h1 align="center">RESTAURANT MANAGEMENT SYSTEM</h1>
<h2 align="center">Register new Product</h2>
<div id="form" style="padding-left:100px">
<form action="Productsdetails.php" method="post" name="form1">
        <table width="98%" border="0" style="padding-left:-100px;">
		
            <tr> 
                <td width="22%"><input type="text" name="ProductName" placeholder="Enter the ProductName" required/> </td>
              <td width="22%"><input type="text" name="Description" placeholder="Enter the Description" required/></td>
			   <td width="22%"><input type="text" name="Costs" placeholder="Enter the Costs" required></td>
			   <td><input type="submit" name="Submit" value="SAVE PRODUCTS"></td>
            </tr>
    </table>
  </form>	

		<h2 align="center">REGISTERED PRODUCTS</h2>
<table width='89%' border=2>
        ...
        while($res = mysqli_fetch_array($result)) {         
            ...
            echo "<td><a href=\"updateproducts.php?ProductID=$res[ProductID]\">Edit Product</a> | <a href=\"deleteproducts.php?ProductID=$res[ProductID]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
        ?>
  </table>
  </div>
